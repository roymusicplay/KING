...
PM_START_TEXT = """
ʜᴇʟʟᴏ [🤗](https://telegra.ph/file/31d8106f1ff2a905df1b7.jpg), ɪᴍ king ᴀ ʜɪɢʜʏ ᴀᴅᴠᴀɴᴄᴇᴅ ʙᴏᴛ ᴡɪᴛʜ ʟᴏᴛꜱ ᴏꜰ ᴀᴍᴀᴢɪɴɢ ᴛᴏᴏʟꜱ.
...
buttons = [
    [
        InlineKeyboardButton(
            text="➕️ 𝙁𝘼𝙏𝙃𝙀𝙍 ➕️", url="t.me/abhinasroy"),
    ],
    [
        InlineKeyboardButton(text="𝘼𝘽𝙊𝙐𝙏", callback_data="yone_"),
        InlineKeyboardButton(
            text="ꜱᴜᴘᴘᴏʀᴛ", url=f"https://t.me/{SUPPORT_CHAT}"
        ),
    ],
    [
        InlineKeyboardButton(text="𝙃𝙀𝙇𝙋 & ᴄᴏᴍᴍᴀɴᴅꜱ❔", callback_data="help_back"),
    ],
]


HELP_STRINGS = """
`ʜɪ.. ɪ'ᴍ` [king🙋‍♀️](https://telegra.ph/file/31d8106f1ff2a905df1b7.jpg) 
`ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʙᴜᴛᴛᴏɴꜱ ʙᴇʟᴏᴡ ᴛᴏ ɢᴇᴛ ᴅᴏᴄᴜᴍᴇɴᴛᴀᴛɪᴏɴ ᴀʙᴏᴜᴛ ꜱᴘᴇᴄɪꜰɪᴄ ᴍᴏᴅᴜʟᴇꜱ..`"""

yone_IMG = "https://telegra.ph/file/31d8106f1ff2a905df1b7.jpg"
    ...
    if query.data == "yone_":
        query.message.edit_text(
            text=""" ℹ️ I'm *yone*, a powerful group management bot built to help you manage your group easily.
                 ...
                 \nHere is the [💾FATHER](t.me/abhinasroy).
